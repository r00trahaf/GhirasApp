...
//                               ),
                          ...
                          Text(
                            "كيف نقدر نخدمك ؟",
                            style:
                            TextStyle(color: "#CFE5A5".toHexa(), fontSize: 20),
                          ),
                        ],
                      ),
                    ),
                ...
                FutureBuilder<List<SupportModel>>(
                    future: Firebase.shared.supportByType(type: SupportType.questions),
                              ...
                              return Container(
                                  ...
                                  child: Column(
                                    children: [
                                      Row(
                                        ...
                                        children: <Widget>[
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                Text(
                                                  support[index].title!,
                                                  style: TextStyle(
                                                      color: "#9DBA89".toHexa(), fontSize: 15),
                                                ),
                                              ],
                                            ),
                                          ),
                                          RawChip(
                                            ...
                                            elevation: 0,
                                            label: isSelected(support[index].subtitle!) ? const Icon(Icons.arrow_upward) : const Icon(Icons.arrow_downward),
                                            selected: isSelected(support[index].subtitle!),
                                            showCheckmark: false,
                                            pressElevation: 0,
                                      ...
                                      Visibility(visible: isSelected(support[index].subtitle!), child: const Divider()),
                                      Visibility(
                                          visible: isSelected(support[index].subtitle!),
